...
const Spotify = {
    async getAccessToken() {
        ...
        // URLSearchParams ka istemaal karke yeh check karo ke browser URL mein valid authorization code hai ya nahi. Saath hi error response bhi check karo.
        ...
        // Agar URL mein code mojood hai, to localStorage se stored code_verifier hasil karo. Uske baad Spotify ke /api/token endpoint par POST request bhejo taake code aur verifier ke badlay access token mil jaye.
        if (code) {
